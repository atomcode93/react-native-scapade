    ...
    return (
      <Container>
        <Wrapper>
          ...
          <Town style={styles.townShadow} onPress={() => this.handleCityPress('London')}>
            <TownPhoto source={require('../../assets/london.jpg')} resizeMode="cover" />
            <TownTitle>LONDON</TownTitle>
          </Town>
          <Town style={styles.townShadow} onPress={() => this.handleCityPress('Rome')}>
